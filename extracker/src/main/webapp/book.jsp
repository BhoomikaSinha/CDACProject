...
<table>
<tr><td><h3 class="sansserif">Add Category : </h3> </td><td><input type="text" name="addcategory" /></td><td> <input type="submit" value="Add Category" />     </td> </tr>
...
<tr><td><h3 class="sansserif">Delete Category : </h3>	    	
									...
									</select></td><td><input type="submit" value="Delete Category" /> </td> </tr>
</table>	
</form>
                </div>
           </div>
